package training.hw3.utils.keywords;
...
import training.hw3.utils.driver.DriverManager;
import training.hw3.utils.driver.DriverManagerFactory;
import training.hw3.utils.driver.DriverType;
...
public class WebUI {
	...
	public void verify(String expectedValue,String actualValue){
		Assert.assertTrue(actualValue.toLowerCase().contains(expectedValue.toLowerCase()),"Expected is: "+expectedValue+" but Actual is: "+actualValue);
	}
}
